...
<div class="contenedor4" id="marcas">
        <h1>Marcas</h1>
            ...
            <?php
              ...
              if($ejecutar->num_rows>0){
                ...
                while($datos = $ejecutar->fetch_assoc()){
                  ...
                  echo "
            <form action='USER_todo' method='post'>
                  <div class='card contenedorAdmin03'>
                  <img src='$ruta' class='card-img-top' alt='imagenMarca'>
                  <div class='card-body'>
                    <h5 class='card-title'>$nombre</h5>
                  </div>
                  <input type='hidden' name='nombre' value='$nombre'>    
                  <button type='submit' class='boton botonHover'>Ver modelos</button>
                </div>
              </form>
              ";
                }
